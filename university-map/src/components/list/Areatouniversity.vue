<template>
  ...
  <script>
  import { getAreatouniversity } from '@/api/areatouniversity'
  export default {
    name: "paging",
    data() {
      return {
    ...
    methods: {
      async getInfo(){
        ...
        this.provinces=this.$route.params.provinces;
        console.log(this.$route.params.provinces);
        const ref = await getAreatouniversity(this.provinces);
        console.log(ref);
