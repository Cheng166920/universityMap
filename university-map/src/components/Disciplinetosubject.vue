<template>
    <div class="paging">
      <div class="box_body">
        <el-table :data="tableData" border size="small" style="width: 100%">
          ...
          <el-table-column
            label="层次"
            prop="university_level"
            min-width="150"
          ></el-table-column>
          <el-table-column
            label="性质"
            prop="university_nature"
            min-width="150"
          ></el-table-column>
        </el-table>
        <!--===分页=====-->
  ...
  <script>
  import { getSubject } from '@/api/disciplinetosubject'
  export default {
    name: "paging",
    data() {
      return {
    ...
    methods: {
      async getInfo(){
        ...
        this.discipline_name=this.$route.params.discipline_name;
        console.log(this.$route.params.discipline_name);
        const ref = await getSubject(this.discipline_name);
        console.log(ref);
